...
// 因为arm不用IDT，所以没那么多设置的东西
// 在arm里面这东西叫做中断向量表
// ARM Cortex-A15处理器默认中断向量表的位置在开头（可以通过SCTLR寄存器中的V位控制）
// ARM v7架构开始，增加 VBAR 寄存器用于存储中断向量表的基地址
// 可以通过读这个寄存器知道中断过向量表的位置

// 一般来说，中断向量表就这些内容（在这个平台上，arm开头映射flash，但是这部分u-boot依然写在这）：
// 地址        异常/中断类型
//0x00000000  Reset
...
// 实测，除了Reset之外，其他的类型全部为0xe59ff014

// 这是u-boot设置的中断向量表和初始的函数：
//(gdb) x /64xw 0x0
//0x0:    0xea0000b8      0xe59ff014      0xe59ff014      0xe59ff014
//0x10:   0xe59ff014      0xe59ff014      0xe59ff014      0xe59ff014
//0x20:   0x00000060      0x000000c0      0x00000120      0x00000180
//0x30:   0x000001e0      0x00000240      0x000002a0      0xdeadbeef
//0x40:   0x0badc0de      0xe320f000      0xe320f000      0xe320f000
//0x50:   0xe320f000      0xe320f000      0xe320f000      0xe320f000
//0x60:   0xe51fd028      0xe58de000      0xe14fe000      0xe58de004
//0x70:   0xe3a0d013      0xe169f00d      0xe1a0e00f      0xe1b0f00e
//0x80:   0xe24dd048      0xe88d1fff      0xe51f2050      0xe892000c
//0x90:   0xe28d0048      0xe28d5034      0xe1a0100e      0xe885000f
//0xa0:   0xe1a0000d      0xeb000906      0xe320f000      0xe320f000
//0xb0:   0xe320f000      0xe320f000      0xe320f000      0xe320f000
//0xc0:   0xe24dd004      0xe58d0000      0xe51f0090      0xe580e000
//0xd0:   0xe14fe000      0xe580e004      0xe590e000      0xe59d0000
//0xe0:   0xe28dd004      0xe24dd048      0xe88d1fff      0xe51f20b4
//0xf0:   0xe892000c      0xe28d0048      0xe28d5034      0xe1a0100e
